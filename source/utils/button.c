...
void gpio_input_init(void)
{
    ...
    PORT3->PCR[0] = PORT_PCR_MUX(0) | PORT_PCR_PE(1) | PORT_PCR_PS(1); // Button 0 - P3_0
    PORT2->PCR[4] = PORT_PCR_MUX(0) | PORT_PCR_PE(1) | PORT_PCR_PS(1); // Button 1 - P2_4
    PORT1->PCR[5] = PORT_PCR_MUX(0) | PORT_PCR_PE(1) | PORT_PCR_PS(1); // Button 2 - P1_5
    PORT1->PCR[4] = PORT_PCR_MUX(0) | PORT_PCR_PE(1) | PORT_PCR_PS(1); // Button 3 - P1_4
